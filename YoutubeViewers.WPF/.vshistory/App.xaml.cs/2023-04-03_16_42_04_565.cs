...
namespace YoutubeViewers.WPF
{
    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            _createYoutubeViewerCommand = new CreateYoutuewerCommand();
            _updateYoutubeViewerCommand = new UpdateYoutuewerCommand();
            _deleteYoutubeViewerCommand = new CreateYoutuewerCommand();
